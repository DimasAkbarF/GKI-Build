...
CUSTOM_MANIFEST_REPO="https://github.com/DimasAkbarF/kernel_manifest_android12-5.10" # depends on USE_CUSTOM_MANIFEST
CUSTOM_MANIFEST_BRANCH="main"                                                      # depends on USE_CUSTOM_MANIFEST
WORK_DIR=$(pwd)
KERNEL_IMAGE="$WORK_DIR/out/${GKI_VERSION}/dist/Image"
ANYKERNEL_REPO="https://github.com/DimasAkbarF/Anykernel3"
